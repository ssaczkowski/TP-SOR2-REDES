...
set terminal png
set output "dumbbell-tp2-cwnd-ssthresh2.png"
...
"dumbbell-tp2-30-cwnd.data" using 1:2 title "cwnd"with lines, \
"dumbbell-tp2-30-ssth.data" using 1:2 title "ssthresh" with lines