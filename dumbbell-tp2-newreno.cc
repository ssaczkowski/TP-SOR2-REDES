...
int main (int argc, char *argv[])
{
  ...
  if (tracing)
  {
    redDumbbell.EnablePcapAll ("dumbbell-tp2-TcpNewReno", false);
    Simulator::Schedule (Seconds (0.00001), &TraceCwnd, "dumbbell-tp2-TcpNewReno-cwnd.data");
    Simulator::Schedule (Seconds (0.00001), &TraceSsThresh, "dumbbell-tp2-TcpNewReno-ssth.data");  
  }
